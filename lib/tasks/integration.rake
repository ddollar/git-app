...
task :integration => %w{ environment:test configure:target gems:install gems:build db:test:purge db:migrate db:test:prepare integration:spec integration:rcov }
